...
import type { Introspector,CallbackOutput } from "./introspector.ts";
type TypeObjectCallback = (subject:string,callback:Introspector) => string;
export function rdf_type(type_function: TypeObjectCallback, subj:string,callback:Introspector):CallbackOutput {
    //const obj =  obj;
